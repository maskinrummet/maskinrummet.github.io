  ...
  en: {
    ...
    activities: {
      textCleaning: {
        ...
        whatYouNeed: "Nothing :)",
        learningGoals:
          "Understand how text can be 'cleaned' into words for processing. Get an introduction to tokenisation.",
        intro:
        ...
        learningOutcomes:
          "Hopefully after completing this lesson you understand what tokenisation is and how it might be used in text processing. You should also have a better understanding of how computers process text as 'strings' of characters, and how this means the 'meaning' of text that's obvious to us people can be much more difficult for a computer.",
        readMore:
          "You can see exactly how ChatGPT and OpenAI's GPT models would tokenise text here: https://platform.openai.com/tokenizer\nIf you're interested in learning more about tokenisation, you can read more about it here: https://www.datacamp.com/blog/what-is-tokenization",
        custom: {
          howComputersSee:
      ...
      textGeneration: {
        ...
        whatYouNeed: "Nothing :)",
        learningGoals:
          "Learn about what stemming and stop words are, and how we can understand text using word clouds. Explore how text can be generated by computers, with different methods. Get an intuition for how randomness plays into good (and unreliable) text generation.",
        intro:
          "How do computers generate text? How can they understand it's meaning? In this lesson we use word clouds to visualise a dataset, and then generate text using it. We'll see how computers can generate text that's creative, but also how they can get it wrong. First, pick or create a dataset to work with.",
        learningOutcomes:
          "Hopefully after completing this lesson you understand what stemming and stop words are, and how they can be used in text processing. You should also have a better understanding of how computers can generate text, and how they can be creative, but also unreliable. You should also have a better understanding of how randomness plays into text generation, and how it can be used to make text generation more creative.",
        readMore:
          "You can try out a stemmer directly here: http://text-processing.com/demo/stem/. A nice explainer video on ngrams is available here: https://www.youtube.com/watch?v=E_mN90TYnlg",
        custom: {
          wordCloudBelow:
