...
const messages = {
  en: {
    ...
    hourOfAI: {
      ...
      surveyText: `... And it would be a massive help to us in continuing our research if you would be interested in taking a short questionnaire!<ul><li><a href="https://survey.au.dk/LinkCollector?key=QYK7HER7L61J" target="_blank">Questionnaire for while you are here on the site and considering teaching (4 mins)</a></li><li><a href="https://survey.au.dk/LinkCollector?key=Q6P7HTP7J21P" target="_blank">Questionnaire for after you have taught the lesson (6 mins)</a></li></ul>`,
      ages: "Ages 10-16",
  ...
  da: {
    ...
    hourOfAI: {
      ...
      surveyTitle:
        "Disse aktiviteter er udviklet med kærlighed gennem forskning",
      ...
      steps: [
        ...
        },
        {
          ...
          teachingPoint: "",
          questions:
            "<ul><li><b>Kan en computer dele ord op, som vi kan?</b> Nogle gange, men den kan ikke gøre det naturligt, som vi lærer at gøre! Typisk vil vi træne en machine-learning model til at finde ud af, hvordan man gør det, men en simpel metode er at dele sætninger op ved mellemrum og tegnsætning.</li><li><b>Hvad gør noget til et ord? Bør ’fodbold’ deles op i to ord, eller er det et enkelt?</b>Dette kan være en interessant diskussion for sproglærere, fordi det berører noget grundlæggende i syntaks og ords oprindelse, og fordi det kan variere mellem forskellige sprog. Det hjælper med at illustrere, hvorfor tekst er komplekse data, og hvorfor andre fagområder kan hjælpe programmører med at designe tekstgenereringssystemer. </li></ul>",
          imageLink: "images/ripped-slip.jpg",
        },
        {
        ...
        },
        {
          ...
          teachingPoint:
            "Det vigtigste her er er at fremhæve, at antallet af gange et ord bliver brugt, påvirker sandsynligheden for, at vi trækker det, hvilket påvirker sætningerne, vi kan generere. Sætningerne, som er forkerte eller mærkelige, kan være de mest spændende for eleverne, og hjælper også med at vise dem, hvordan fejl kan opstå, når vi bruger sandsynlighed som udgangspunkt for tekstgenerering.",
          questions: "",
          imageLink: "images/pool-generation.jpg",
        },
        {
          text: "Eventuelt kan hver bunke visualiseres med et cirkeldiagram, hvor størrelsen på sektorerne repræsenterer ordets frekvens. Diagrammerne kan derefter drejes som et ”wheel of fortune” for at generere en ny sætning.",
          teachingPoint:
        ...
        },
        {
          ...
          teachingPoint:
            "Dette kan være et sjovt, afsluttende trin i aktiviteten. Giv dem et par ekstra hjul eller stykker papir, og bed dem om at lave hjul, bunker eller regler, der resulterer i en bedre tekstgenereringsmodel. <br><br> ”Bedre” kan betyde mange ting – mere kreativ, bedre grammatik eller flere sætninger, der er sande. Du kan definere dette for eleverne eller bede dem om efterfølgende at forklare, hvad de forstår som ”bedre”.",
          questions: "",
          imageLink: "images/once-upon-a-billion.jpg",
        },
      ],
